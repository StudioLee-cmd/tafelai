            ...
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <div className="mt-8 bg-[var(--card-background)] rounded-2xl p-6 shadow-xl border border-[var(--card-border)] text-center lg:text-left">
                        ...
                        <a href="mailto:tim@tafelai.nl" className="text-xl lg:text-2xl text-primary font-bold hover:text-primary-accent transition-colors">
                            tim@tafelai.nl
                        </a>
                    </div>
                    ...
                    <div className="mt-8 lg:mt-10 bg-gradient-to-br from-[#1a1a1a] to-[#2d2d2d] rounded-2xl p-8 text-center text-white shadow-2xl relative overflow-hidden border border-yellow-500/30">
                        ...
                        <h3 className="text-xl font-bold mb-3 relative z-10">Klaar om je restaurant te transformeren?</h3>
                        <p className="text-gray-300 mb-6 text-sm leading-relaxed relative z-10">
                            Gemiddeld besparen onze klanten 8+ uur per week aan administratie en telefoontjes. Daarnaast heb je geen lege tafels meer door no-shows. Eén extra reservering per week dekt vaak de kosten al.
                        </p>
