...
import { comparisonData, totalTraditionalCost, tafelAICost } from '@/data/comparison';
...
const CostComparison: React.FC = () => {
    return (
        <Section
            ...
            description="Stop met het verspillen van geld aan duur (kantoor)personeel. TafelAI doet het beter, sneller en goedkoper."
        >
            <Container>
                    ...
                    <Link href="#pricing" className="block w-full">
                        ...
                        >
                            ...
                            <h3 className="text-2xl lg:text-3xl font-bold mb-2 relative z-10">
                                De <Highlight color="primary" className="text-3xl lg:text-4xl">TafelAI</Highlight> Manier
                            </h3>
                            ...
                            <div className="border-t border-gray-700 pt-8 relative z-10">
                                ...
                                <div className="flex items-baseline gap-2">
                                    <span className="text-5xl lg:text-6xl font-black text-primary">€ {tafelAICost},-</span>
                                ...
                                >
                                    Je bespaart € {totalTraditionalCost - tafelAICost} per maand!
                                </motion.p>
                            </div>
                        </motion.div>
                    </Link>
