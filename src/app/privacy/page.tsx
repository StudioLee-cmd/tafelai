        ...
        <Container>
            <div className="py-20 max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg text-foreground-accent">
                    ...
                    <p>
                        Je privacy is voor TafelAI (onderdeel van <strong>DigitalStudioLee</strong>) van groot belang. Wij houden ons dan ook aan de privacywetgeving (AVG/GDPR). Dit betekent dat je gegevens bij ons veilig zijn en dat wij ze altijd netjes gebruiken.
                    </p>

                    <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">1. Gegevensverwerking</h2>
                    <p>
                        Wij verwerken persoonsgegevens die nodig zijn voor het leveren van onze diensten, zoals naam, adres, telefoonnummer en e-mailadres. Daarnaast verwerkt onze AI gespreksdata om reserveringen te kunnen inplannen.
                    </p>
                    ...
                    <p>
                        Je hebt altijd het recht op inzage in je gegevens. Ook kun je ons verzoeken gegevens aan te passen of te verwijderen. Neem hiervoor contact op via tim@tafelai.nl.
                    </p>
